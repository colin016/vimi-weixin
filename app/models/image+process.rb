...
module ImageWithProcess
  ...
  def front
    ...
    image.format = 'jpg'
    canvas.format = 'png'
    canvas.composite!(image.resize_to_fill(391, 272), 30, 31, Magick::AtopCompositeOp)

    canvas
  end

  def back
    @canvas = Magick::ImageList.new("#{Rails.public_path}/images/postcard_template.png")
    ...
    text = self.order.content || "Hello World!"
